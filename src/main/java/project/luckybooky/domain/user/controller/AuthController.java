...
public class AuthController {
    ...
    public BaseResponse<JoinResultDTO> kakaoLogin(
            ...
            @Parameter(description = "카카오 OAuth2 인증 후 리다이렉트할 URI (로컬 환경 -> http://localhost:3000/login/kakao / 배포 환경 -> https://api-movie-bookie.shop/login/kakao)", required = true) String redirectUri,
